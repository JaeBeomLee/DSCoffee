 ...
 */
public class White_Chocolate_Mocha extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        float []price = new float[]{0,3500,0,0,0,3500,3200};
        float []oz = new float[]{10,13,13,13,0,12,12};
        float []price30 = new float[7];
        for(int i = 0; i < price.length; i++){
            String temp =  String.format("%.2f",price[i]/3500);
        ...
        if(MainActivity.btn == 0) {
            ...
            coffee.setImageResource(R.drawable.white_chocolate_moca);
            ...
            imag.setText(""+Integer.toString(Math.round(price[0])) +"원");
            imag2.setText("이디야                  "+Integer.toString(Math.round(price[1]))+"원");
            imag3.setText(""+Integer.toString(Math.round(price[2]))+"원");
            imag4.setText(""+Integer.toString(Math.round(price[3]))+"원");
            imag5.setText(""+Integer.toString(Math.round(price[4]))+"원");
            imag6.setText(", 팬도로시");
            imag7.setText("프라빈 "+Integer.toString(Math.round(price[6]))+"원");

            imag2.setTextSize(13.0f);
            imag6.setTextSize(13.0f);
        }else if(MainActivity.btn ==1){
            coffee.setImageResource(R.drawable.waterdrop_whitemoca);
            ani = new TranslateAnimation(
                    Animation.RELATIVE_TO_PARENT, 0.0f,
                    Animation.RELATIVE_TO_PARENT, 0.0f,
                    Animation.RELATIVE_TO_PARENT, widthSet,
                    Animation.RELATIVE_TO_PARENT, price30_2[0]/35.0f - 0.05f);
            ani2 = new TranslateAnimation(
                    Animation.RELATIVE_TO_PARENT, 0.0f,
                    Animation.RELATIVE_TO_PARENT, 0.0f,
                    Animation.RELATIVE_TO_PARENT, widthSet,
                    Animation.RELATIVE_TO_PARENT, price30_2[6]/35.0f - 0.05f);
            ani3 = new TranslateAnimation(
                    Animation.RELATIVE_TO_PARENT, 0.0f,
                    Animation.RELATIVE_TO_PARENT, 0.0f,
                    Animation.RELATIVE_TO_PARENT, widthSet,
                    Animation.RELATIVE_TO_PARENT, price30_2[2]/35.0f - 0.05f);
            ani4 = new TranslateAnimation(
                    Animation.RELATIVE_TO_PARENT, 0.0f,
                    Animation.RELATIVE_TO_PARENT, 0.0f,
                    Animation.RELATIVE_TO_PARENT, widthSet,
                    Animation.RELATIVE_TO_PARENT, price30_2[3]/35.0f - 0.05f);
            ani5 = new TranslateAnimation(
                    Animation.RELATIVE_TO_PARENT, 0.0f,
                    Animation.RELATIVE_TO_PARENT, 0.0f,
                    Animation.RELATIVE_TO_PARENT, widthSet,
                    Animation.RELATIVE_TO_PARENT, price30_2[4]/35.0f - 0.05f);
            ani6 = new TranslateAnimation(
                    Animation.RELATIVE_TO_PARENT, 0.0f,
                    Animation.RELATIVE_TO_PARENT, 0.0f,
                    Animation.RELATIVE_TO_PARENT, widthSet,
                    Animation.RELATIVE_TO_PARENT, price30_2[5]/35.0f - 0.05f);
            ani7 = new TranslateAnimation(
                    Animation.RELATIVE_TO_PARENT, 0.0f,
