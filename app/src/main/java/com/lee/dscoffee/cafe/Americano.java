...
import com.lee.dscoffee.DBHelper;
...
public class Americano extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        float []price = new float[]{2900,2800,2300,3000,2000,1500,2500};
        float []oz = new float[]{10,13,13,13,0,12,12};
        float []price30 = new float[7];
        for(int i = 0; i < price.length; i++){
            String temp =  String.format("%.2f",price[i]/3000);
        ...
        if(MainActivity.btn == 0) {
            ...
            coffee.setImageResource(R.drawable.americano3);
            ...
            imag4.setText("콩볶는집 " + Integer.toString(Math.round(price[3]))+"원");
            imag5.setText("MyCoffee " + Integer.toString(Math.round(price[4]))+"원");
            imag6.setText("팬도르시 " + Integer.toString(Math.round(price[5]))+"원");
            imag7.setText("프라빈 " + Integer.toString(Math.round(price[6]))+"원");

        }else if(MainActivity.btn ==1){
            coffee.setImageResource(R.drawable.waterdrop_americano);
            ani = new TranslateAnimation(
                    Animation.RELATIVE_TO_PARENT, 0.0f,
                    Animation.RELATIVE_TO_PARENT, 0.0f,
                    Animation.RELATIVE_TO_PARENT, widthSet,
                    Animation.RELATIVE_TO_PARENT, price30_2[0]/30.0f - 0.05f);
            ani2 = new TranslateAnimation(
                    Animation.RELATIVE_TO_PARENT, 0.0f,
                    Animation.RELATIVE_TO_PARENT, 0.0f,
                    Animation.RELATIVE_TO_PARENT, widthSet,
                    Animation.RELATIVE_TO_PARENT, price30_2[1]/30.0f - 0.05f);
            ani3 = new TranslateAnimation(
                    Animation.RELATIVE_TO_PARENT, 0.0f,
                    Animation.RELATIVE_TO_PARENT, 0.0f,
                    Animation.RELATIVE_TO_PARENT, widthSet,
                    Animation.RELATIVE_TO_PARENT, price30_2[2]/30.0f - 0.05f);
            ani4 = new TranslateAnimation(
                    Animation.RELATIVE_TO_PARENT, 0.0f,
                    Animation.RELATIVE_TO_PARENT, 0.0f,
                    Animation.RELATIVE_TO_PARENT, widthSet,
                    Animation.RELATIVE_TO_PARENT, price30_2[3]/30.0f - 0.05f);
            ani5 = new TranslateAnimation(
                    Animation.RELATIVE_TO_PARENT, 0.0f,
                    Animation.RELATIVE_TO_PARENT, 0.0f,
                    Animation.RELATIVE_TO_PARENT, widthSet,
                    Animation.RELATIVE_TO_PARENT, price30_2[4]/30.0f - 0.05f);
            ani6 = new TranslateAnimation(
                    Animation.RELATIVE_TO_PARENT, 0.0f,
                    Animation.RELATIVE_TO_PARENT, 0.0f,
                    Animation.RELATIVE_TO_PARENT, widthSet,
                    Animation.RELATIVE_TO_PARENT, price30_2[5]/30.0f - 0.05f);
            ani7 = new TranslateAnimation(
                    Animation.RELATIVE_TO_PARENT, 0.0f,
                    Animation.RELATIVE_TO_PARENT, 0.0f,
                    Animation.RELATIVE_TO_PARENT, widthSet,
                    Animation.RELATIVE_TO_PARENT, price30_2[6]/30.0f - 0.05f);

            imag.setText("Coffea "+Integer.toString(Math.round(price30_2[0])) +"원");
            imag2.setText("Ediya "+Integer.toString(Math.round(price30_2[1]))+"원");
            imag3.setText("Hans " + Integer.toString(Math.round(price30_2[2]))+"원");
            imag4.setText("콩볶는집 " + Integer.toString(Math.round(price30_2[3]))+"원");
            imag5.setText("");
            imag6.setText("팬도르시 "+Integer.toString(Math.round(price30_2[5]))+"원");
            imag7.setText("프라빈 "+Integer.toString(Math.round(price30_2[6]))+"원");
        }
