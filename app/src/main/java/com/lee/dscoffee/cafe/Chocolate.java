...
public class Chocolate extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        float []price = new float[]{0,3200,3500,4000,0,2500,2800};
        ...
        if(MainActivity.btn == 0) {
            ...
            coffee.setImageResource(R.drawable.chocolate);
            ...
            coffee.setImageResource(R.drawable.waterdrop_chocolate);
            ani = new TranslateAnimation(
                    Animation.RELATIVE_TO_PARENT, 0.0f,
                    Animation.RELATIVE_TO_PARENT, 0.0f,
                    Animation.RELATIVE_TO_PARENT, widthSet,
            ...
            ani7 = new TranslateAnimation(
                    ...
                    Animation.RELATIVE_TO_PARENT, 0.0f,
                    Animation.RELATIVE_TO_PARENT, widthSet,
                    Animation.RELATIVE_TO_PARENT, price30_2[6]/40.0f - 0.05f);
            imag.setText("");
