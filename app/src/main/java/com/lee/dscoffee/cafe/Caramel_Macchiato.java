 ...
 */
public class Caramel_Macchiato extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        float []price = new float[]{3800,3500,3500,4500,3500,3500,3200};
        ...
        if(MainActivity.btn == 0) {
            ...
            coffee.setImageResource(R.drawable.caramel_macciato);
            ...
            ani2 = new TranslateAnimation(
                    Animation.RELATIVE_TO_PARENT, 0.0f,
                    Animation.RELATIVE_TO_PARENT, -0.105f,
                    Animation.RELATIVE_TO_PARENT, widthSet,
            ...
            ani6 = new TranslateAnimation(
                    Animation.RELATIVE_TO_PARENT, 0.0f,
                    Animation.RELATIVE_TO_PARENT, 0.12f,
                    Animation.RELATIVE_TO_PARENT, widthSet,
            ...
            imag3.setTextSize(13.0f);
            imag5.setTextSize(13.0f);
            imag6.setTextSize(13.0f);
        }else if(MainActivity.btn ==1){
            coffee.setImageResource(R.drawable.waterdrop_macchiato);
            ani = new TranslateAnimation(
                    Animation.RELATIVE_TO_PARENT, 0.0f,
                    Animation.RELATIVE_TO_PARENT, 0.0f,
                    Animation.RELATIVE_TO_PARENT, widthSet,
            ...
            ani3 = new TranslateAnimation(
                    Animation.RELATIVE_TO_PARENT, 0.0f,
                    Animation.RELATIVE_TO_PARENT, -0.078f,
                    Animation.RELATIVE_TO_PARENT, widthSet,
        ...
        name.setText("Caramel Macchiato");
