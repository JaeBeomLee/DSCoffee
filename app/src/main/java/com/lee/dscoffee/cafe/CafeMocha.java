 ...
 */
public class CafeMocha extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if(MainActivity.btn == 0) {
            ...
            coffee.setImageResource(R.drawable.cafe_mocha2);
            ...
            coffee.setImageResource(R.drawable.waterdrop_cafemocha);
            ani = new TranslateAnimation(
                    Animation.RELATIVE_TO_PARENT, 0.0f,
                    Animation.RELATIVE_TO_PARENT, 0.0f,
                    Animation.RELATIVE_TO_PARENT, widthSet,
            ...
            ani2 = new TranslateAnimation(
                    ...
                    Animation.RELATIVE_TO_PARENT, 0.0f,
                    Animation.RELATIVE_TO_PARENT, widthSet,
                    Animation.RELATIVE_TO_PARENT, price30_2[1]/45.0f - 0.05f);
            ani3 = new TranslateAnimation(
                    Animation.RELATIVE_TO_PARENT, 0.0f,
                    Animation.RELATIVE_TO_PARENT, -0.085f,
                    Animation.RELATIVE_TO_PARENT, widthSet,
            ...
            ani6 = new TranslateAnimation(
                    Animation.RELATIVE_TO_PARENT, 0.0f,
                    Animation.RELATIVE_TO_PARENT, 0.09f,
                    Animation.RELATIVE_TO_PARENT, widthSet,
                    Animation.RELATIVE_TO_PARENT, price30_2[2]/45.0f - 0.05f);
            ani7 = new TranslateAnimation(
                    Animation.RELATIVE_TO_PARENT, 0.0f,
