 ...
 */
public class CafeLatte extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        float []price = new float[]{3800,3200,3000,4000,3000,2500,2800};
        float []oz = new float[]{10,13,13,13,0,12,12};
        float []price30 = new float[7];
        for(int i = 0; i < price.length; i++){
            String temp =  String.format("%.2f",price[i]/4000);
        ...
        if(MainActivity.btn == 0) {
            ...
            coffee.setImageResource(R.drawable.cafe_latte3);
            ...
            ani3 = new TranslateAnimation(
                    Animation.RELATIVE_TO_PARENT, 0.0f,
                    Animation.RELATIVE_TO_PARENT, 0.04f,
                    Animation.RELATIVE_TO_PARENT, widthSet,
            ...
            coffee.setImageResource(R.drawable.waterdrop_cafelatte);
            ani = new TranslateAnimation(
                    Animation.RELATIVE_TO_PARENT, 0.0f,
                    Animation.RELATIVE_TO_PARENT, 0.0f,
                    Animation.RELATIVE_TO_PARENT, widthSet,
                    Animation.RELATIVE_TO_PARENT, price30_2[0]/40.0f - 0.05f);
            ani2 = new TranslateAnimation(
                    Animation.RELATIVE_TO_PARENT, 0.0f,
                    Animation.RELATIVE_TO_PARENT, 0.0f,
                    Animation.RELATIVE_TO_PARENT, widthSet,
                    Animation.RELATIVE_TO_PARENT, price30_2[1]/40.0f - 0.05f);
            ani3 = new TranslateAnimation(
                    Animation.RELATIVE_TO_PARENT, 0.0f,
                    Animation.RELATIVE_TO_PARENT, 0.0f,
                    Animation.RELATIVE_TO_PARENT, widthSet,
                    Animation.RELATIVE_TO_PARENT, price30_2[2]/40.0f - 0.05f);
            ani4 = new TranslateAnimation(
                    Animation.RELATIVE_TO_PARENT, 0.0f,
                    Animation.RELATIVE_TO_PARENT, 0.0f,
                    Animation.RELATIVE_TO_PARENT, widthSet,
                    Animation.RELATIVE_TO_PARENT, price30_2[3]/40.0f - 0.05f);
            ani5 = new TranslateAnimation(
                    Animation.RELATIVE_TO_PARENT, 0.0f,
                    Animation.RELATIVE_TO_PARENT, 0.0f,
                    Animation.RELATIVE_TO_PARENT, widthSet,
                    Animation.RELATIVE_TO_PARENT, price30_2[4]/40.0f - 0.05f);
            ani6 = new TranslateAnimation(
                    Animation.RELATIVE_TO_PARENT, 0.0f,
                    Animation.RELATIVE_TO_PARENT, 0.0f,
                    Animation.RELATIVE_TO_PARENT, widthSet,
                    Animation.RELATIVE_TO_PARENT, price30_2[5]/40.0f - 0.05f);
            ani7 = new TranslateAnimation(
                    Animation.RELATIVE_TO_PARENT, 0.0f,
